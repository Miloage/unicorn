    ...
    <div class="weui-tab__bd proinfo-tab-con">
      <div id="tab1" class="weui-tab__bd-item weui-tab__bd-item--active">
        ...
        <div class="swiper-container swiper-zhutu">
          <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="/img/zhutu01.jpg" /></div>
            <div class="swiper-slide"><img src="/img/zhutu02.jpg" /></div>
            <div class="swiper-slide"><img src="/img/zhutu03.jpg" /></div>
            <div class="swiper-slide"><img src="/img/zhutu04.jpg" /></div>
            <div class="swiper-slide"><img src="/img/zhutu05.jpg" /></div>
          </div>
      ...
      <div id="tab2" class="weui-tab__bd-item ">
        <div class="pro-detail">
          <img src="/img/xq1.jpg" /><img src="/img/xq2.jpg" /><img src="/img/xq3.jpg" /><img src="/img/xq4.jpg" /><img src="/img/xq5.jpg" /><img src="/img/xq6.jpg" /><img src="/img/xq7.jpg" /><img src="/img/xq8.jpg" /><img src="/img/xq9.jpg" />
        </div>
      </div>
      <div id="tab3" class="weui-tab__bd-item">
        ...
        <div class="weui-panel__bd">
          <div class="wy-media-box weui-media-box_text">
            <div class="weui-cell nopd weui-cell_access">
              <div class="weui-cell__hd"><img src="/img/profile.jpg" alt="" style="width:20px;margin-right:5px;display:block"></div>
            ...
            <ul class="weui-uploader__files clear mg-com-img">
                <li class="weui-uploader__file" style="background-image:url(/img/pro3.jpg)"></li>
                <li class="weui-uploader__file" style="background-image:url(/img/pro3.jpg)"></li>
                <li class="weui-uploader__file" style="background-image:url(/img/pro3.jpg)"></li>
            </ul>
          </div>
        ...
        <div class="weui-panel__bd">
          <div class="wy-media-box weui-media-box_text">
            ...
            <p class="weui-media-box__desc">面料不错，码数也正常  男朋友面料不错，码数也正常  男朋友穿的面料不错，码数也正常  男朋友穿的穿的很合适。</p>
            <ul class="weui-uploader__files clear mg-com-img">
                <li class="weui-uploader__file" style="background-image:url(/img/pro3.jpg)" onclick="window.location.reload('gallery.html')"></li>
                <li class="weui-uploader__file" style="background-image:url(/img/ban2.jpg)" onclick="window.location.reload('gallery.html')"></li>
                <li class="weui-uploader__file" style="background-image:url(/img/pro3.jpg)" onclick="window.location.reload('gallery.html')"></li>
            </ul>
          </div>
        </div>
  ...
  <div class="weui-popup__modal">
    ...
    <div class="modal-content">
      <div class="weui-msg" style="padding-top:0;">
        ...
        <div class="weui-msg__opr-area">
          <p class="weui-btn-area">
            <a href="/payment" class="weui-btn weui-btn_primary">立即购买</a>
            <a href="javascript:;" class="weui-btn weui-btn_default close-popup">不，我再看看</a>
          </p>
        </div>
      </div>
